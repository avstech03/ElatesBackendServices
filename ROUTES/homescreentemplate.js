...
module.exports = app => {
    /* ADMIN APIS */
    app.post(`${config.api.admin}/homescreentemplate`, (req, res) => createTemplate(req, res));
    app.get(`${config.api.admin}/homescreentemplate`, (req, res) => getTemplate(req, res));

    /* USER APIS */
    app.get(`${config.api.user}/homescreentemplate`, (req, res) => getTemplate(req, res));
}