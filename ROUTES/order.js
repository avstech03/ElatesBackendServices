...
module.exports = app => {
    /* ADMIN APIS */
    app.get(`${config.api.admin}/order`, (req, res) => getOrdersForAdmin(req, res));
    app.put(`${config.api.admin}/order/:orderId`, (req, res) => editOrder(req, res));

    /* USER APIS */
    app.post(`${config.api.user}/order`, (req, res) => createOrder(req, res));
    app.get(`${config.api.user}/order`, (req, res) => getOrders(req, res));
    app.put(`${config.api.user}/order/:orderId`, (req, res) => editOrder(req, res));
};