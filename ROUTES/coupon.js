...
module.exports = app => {
    ...
    app.put(`${config.api.admin}/coupon/:couponId`, (req, res) => editCoupon(req, res));
    app.get(`${config.api.admin}/coupon/:couponId`, (req, res) => getCouponById(req, res));
    app.delete(`${config.api.admin}/coupon/:couponId`, (req, res) => deleteCoupon(req, res));

    /* USER APIS */
    app.get(`${config.api.user}/coupon`, (req, res) => getCoupons(req, res));
    app.get(`${config.api.user}/coupon/:code`, (req, res) => getCouponByCode(req, res));
}