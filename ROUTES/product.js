...
const getProductsByCategoryId = (req, res) => {
  ...
  return serviceHandler(
    req,
    res,
    serviceInst.getProductsByCategoryId(categoryId)
  );
};
...
module.exports = (app) => {
  ...
  app.put(`${config.api.admin}/products/:productId`, (req, res) =>
    editProduct(req, res)
  );
  app.get(`${config.api.admin}/products`, (req, res) =>
    getAllProducts(req, res)
  );
  app.get(`${config.api.admin}/products/:productId`, (req, res) =>
    getProductById(req, res)
  );
  app.delete(`${config.api.admin}/products/:productId`, (req, res) =>
    deleteProductById(req, res)
  );
  app.put(`${config.api.admin}/productnames`, (req, res) =>
    getProductNames(req, res)
  );
  app.get(`${config.api.admin}/productname/:productName`, (req, res) =>
    getProductsByName(req, res)
  );

  /* USER APIS */
  app.get(`${config.api.user}/products`, (req, res) =>
    getAllProducts(req, res)
  );
  app.get(`${config.api.user}/products/:productId`, (req, res) =>
    getProductById(req, res)
  );
  app.get(`${config.api.user}/products/category/:categoryId`, (req, res) =>
    getProductsByCategoryId(req, res)
  );
  app.put(`${config.api.user}/products`, (req, res) =>
    getProductsByIds(req, res)
  );
  app.put(`${config.api.user}/products/name`, (req, res) =>
    getProductNames(req, res)
  );
};
